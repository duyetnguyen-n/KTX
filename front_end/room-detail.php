...
<div id="slide-9">
    <div class="container-in-slide9">
        <div class="column-word text-center">
            <div class ="row1-slide6">
                <h2 class="big-text">Powered By</h2>
            </div>
            <div class ="row2-slide6">
                <p class ="small-text no-margin">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                </p>
        ...
        <div class="slide pb-5">
            <div class="owl-carousel">
                <div class="item">
                    <div class="img1-slide9">
                        <img src="assets/images/Elite.png">
                    </div>
                </div>
                <div class="item">
                    <div class="img2-slide9">
                        <img src="assets/images/Timber-land.png" >
                    </div>

                </div>
                <div class="item">
                    <div class="img3-slide9">
                        <img src="assets/images/Elite.png" >
                    </div>

                </div>
                <div class="item">
                    <div class="img4-slide9">
                        <img src="assets/images/america-coffee.png">
                    </div>
                </div>
                <div class="item">
                    <div class="img5-slide9">
                        <img src="assets/images/Williams.png">
                    </div>
                </div>
                <div class="item">
                    <div class="img6-slide9">
                        <img src="assets/images/Fairlane.png">
                    </div>
                </div>
