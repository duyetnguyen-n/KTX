            ...
            <div class="col-12 container-content">
                <div class="header-content pb-3">
                    <div class="title-content">
                        <h3 class="m-0 strong">Danh sách loại trang thiết bị</h3>
                        <div class="span">Quản lý loại trang thiết bị</div>
                    </div>
                    <a href="add-rooms.php" class="button-add">
                        <i class="fas fa-plus"></i>
                        <span>Thêm loại trang thiết bị mới</span>
                    </a>
                </div>
                            ...
                            <table class="table-data">
                                ...
                                <?php while ($row = $result->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center"><img class="img-fluid img-responsive mr-2" height="10" width="10" src="../assets/img/<?php echo $row['anh']; ?>" alt="Dich vu ki tuc xa"> <?php echo $row['tenloaitrangthietbi']; ?></td>
                                        <td><span> </span><?php echo $row['soluong']; ?></td>
                                        <td><?php echo $row['ngaytao']; ?></td>
                                        
                                        <td><?php echo $row['nguoitao'] ?></td>
                                        <td class="d-flex thao-tac">
                                            <a class="me-3" href="../front_end/dichvu-detail.php?id=<?php echo $row['maloaitrangthietbi'];?>">
                                                <img src="../assets/img/eye.svg" alt="img" class="img-fluid">
                                            </a>
                                            <a class="me-3" href="edit-loaitrangthietbi.php?id=<?php echo $row['maloaitrangthietbi']; ?>">
                                                <img src="../assets/img/edit.svg" alt="img" class="img-fluid icon-edit">
                                            </a>
                                            <a class="confirm-text" href="delete-loaitrangthietbi.php?id=<?php echo $row['maloaitrangthietbi']; ?>">
