                            ...
                            <table class="table-data">
                                ...
                                <?php while ($row = $result->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center"><img class="img-fluid img-responsive mr-2" height="10" width="10" src="../assets/img/<?php echo $row['anh']; ?>" alt="Dich vu ki tuc xa"> <?php echo $row['ten_dv']; ?></td>
                                        ...
                                        <td class="d-flex thao-tac">
                                            ...
                                            <a class="confirm-text" href="xoa-dv.php?id=<?php echo $row['id']; ?>">
