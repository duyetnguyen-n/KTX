...
if ($db->update($sql)) {
    echo '<script>alert("Sửa sinh viên thành công!"); window.location.href = "list-sv.php";</script>';
    exit(); // Đảm bảo dừng thực thi mã nguồn sau khi chuyển hướng
} else {
    echo '<script>alert("Lỗi khi sửa sinh viên ' . $db->getError() . '");</script>';
}
}?>
...
<div class="col-md-9">
    <div class="col-12 container-content">
        ...
        <div class="content-add-room col-12">
            <form action="edit-sv.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
